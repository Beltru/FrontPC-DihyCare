...
import {PieChart, Area, ResponsiveContainer, YAxis, XAxis, CartesianGrid, Tooltip, Legend } from "recharts"
const productSales = [
   { 
 name: "Jan",
product1: 4000,
...
return(
    <ResponsiveContainer width="100%" height="100%" >
        <PieChart width={500} height={400} data={productSales} margin={{right: 30}}>
